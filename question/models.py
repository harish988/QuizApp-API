...
class Quiz(models.Model):
    ...
    quiz_image = models.ImageField(upload_to="quiz/staticfiles", null=True, blank=True)
    hardness_choices = (
        ('BEGINNER', 'Beginner'),
...
class Answer(models.Model):
    ...
    answer_image = models.ImageField(upload_to="quiz/staticfiles", null=True, blank=True)
